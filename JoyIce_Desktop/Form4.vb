...
Public Class Form4
    ...
    Private Sub lstDocuments_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstDocuments.SelectedIndexChanged
        ...
        If lstDocuments.SelectedIndex <> -1 Then
            ...
            BunifuTextBox1.Text = selectedItem.GetValue("fname").AsString
            BunifuTextBox2.Text = selectedItem.GetValue("lname").AsString
            BunifuTextBox3.Text = selectedItem.GetValue("age").AsString
            BunifuTextBox4.Text = selectedItem.GetValue("address").AsString
            BunifuTextBox5.Text = selectedItem.GetValue("cnumber").AsString
            BunifuTextBox6.Text = selectedItem.GetValue("email").AsString
            BunifuTextBox7.Text = selectedItem.GetValue("username").AsString
            BunifuTextBox8.Text = selectedItem.GetValue("password").AsString
